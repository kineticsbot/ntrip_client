...
def generate_launch_description():
      ...
      config_file = os.path.join(get_package_share_directory("ntrip_client"),"cfg","ntrip_client.yaml")     
      # Load the parameters specific to your ComposableNode
      with open(config_file, 'r') as file:
          configParams = yaml.safe_load(file)['ntrip_client']['ros__parameters']   
      ...
      return LaunchDescription([
          ...
          Node(
                ...
                remappings=[
                  ("nmea", configParams['nmea_topic_name'])
                ],
          )
      ])
